...
<nav class="navbar" id="navbar">
  <div class="navbar-inner">
    ...
    <ul class="navbar-menu">
      ...
      <li><a href="{{ route('cari-donor') }}">Cari Donor</a></li>
      <li><a href="{{ route('permintaan-darurat') }}">Permintaan Darurat</a></li>
      <li><a href="{{ route('edukasi') }}">Edukasi</a></li>
    </ul>
    <div class="navbar-actions">
      @auth
        <span style="font-size:0.875rem;font-weight:600;color:var(--text-strong)">👤 {{ explode(' ', auth()->user()->name)[0] }}</span>
...
<div class="mobile-menu" id="mobileMenu">
  ...
  <a href="{{ route('cari-donor') }}">Cari Donor</a>
  <a href="{{ route('permintaan-darurat') }}">Permintaan Darurat</a>
  ...
  <div style="margin-top:8px;padding-top:8px;border-top:1px solid var(--border);display:flex;gap:8px">
    @auth
      <a href="{{ route('dashboard') }}" class="btn btn-ghost btn-sm" style="flex:1">Dashboard</a>
    @else
      <a href="{{ route('login') }}" class="btn btn-ghost btn-sm" style="flex:1">Masuk</a>
      <a href="{{ route('login') }}" class="btn btn-primary btn-sm" style="flex:1">Daftar</a>
    @endauth
  </div>
</div>
  ...
  <div class="hero-inner" style="grid-template-columns:1fr;text-align:center;gap:0">
    <div class="hero-content" style="max-width:680px;margin:0 auto">
      ...
      <div class="hero-cta" style="justify-content:center">
        <a href="{{ route('cari-donor') }}" class="btn btn-primary btn-lg">
    ...
    <div style="background:linear-gradient(135deg,var(--red-50) 0%,white 60%,var(--red-50) 100%);border:1px solid var(--red-100);border-radius:var(--r-3xl);padding:64px 48px;text-align:center;position:relative;overflow:hidden">
      ...
      <div style="position:relative;z-index:1">
        ...
        <div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap">
          ...
          <a href="{{ route('cari-donor') }}" class="btn btn-ghost btn-lg">Lihat Pendonor →</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="footer-grid">
      ...
      <div>
        ...
        <div class="footer-links">
          ...
          <a href="{{ route('cari-donor') }}">Cari Donor</a>
          <a href="{{ route('permintaan-darurat') }}">Permintaan Darurat</a>
          <a href="{{ route('edukasi') }}">Edukasi Donor</a>
        </div>
      </div>
      <div>
        ...
        <div class="footer-links">
          @auth
            ...
            <a href="{{ route('profil-donor') }}">Profil Donor</a>
          @else
