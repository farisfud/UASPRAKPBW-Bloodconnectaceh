...
<div class="layout-wrapper">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a href="{{ route('cari-donor') }}" class="active"><span class="nav-icon">🔍</span> Cari Donor</a>
  ...
  <main class="main-content">
    <div class="page-header">
      ...
      <a href="{{ route('permintaan-darurat') }}" class="btn btn-primary btn-sm">+ Ajukan Permintaan</a>
    </div>
...
<script>
  ...
  window.dummyDonors = @json($donors);
</script>
