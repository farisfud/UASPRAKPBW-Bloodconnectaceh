...
<div class="layout-wrapper">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a href="{{ route('permintaan-darurat') }}" class="active"><span class="nav-icon">🚨</span> Permintaan Darurat</a>
  ...
  <main class="main-content">
    <div class="page-header">
      ...
      <a href="{{ route('riwayat-permintaan') }}" class="btn btn-ghost btn-sm">📋 Riwayat Permintaan</a>
    </div>
    ...
    <div class="page-content">
      ...
      <div class="grid-2" style="align-items:start;gap:28px">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <form id="requestForm" method="POST" action="{{ route('blood-request.store') }}">
              @csrf
