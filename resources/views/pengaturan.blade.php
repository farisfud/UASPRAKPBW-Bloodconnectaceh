...
<div class="layout-wrapper">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a href="{{ route('pengaturan') }}" class="active"><span class="nav-icon">⚙️</span> Pengaturan</a>
      ...
      <div class="grid-2" style="align-items:start;gap:24px">
        ...
        <div style="display:flex;flex-direction:column;gap:20px">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div style="display:flex;align-items:center;gap:16px;margin-bottom:24px;padding-bottom:20px;border-bottom:1px solid var(--border)">
                ...
                <div>
                  <div style="font-weight:700;color:var(--text-strong);margin-bottom:4px">{{ auth()->user()->name }}</div>
                  <div class="text-sm text-light mb-12">{{ auth()->user()->email }}</div>
                  <button class="btn btn-ghost btn-sm" onclick="showToast('Fitur ganti foto akan segera tersedia', 'info')">📷 Ganti Foto</button>
                </div>
              </div>
              <form id="settingsForm" method="POST" action="{{ route('pengaturan.update') }}">
                @csrf
                ...
                <div class="form-group">
                  ...
                  <input type="tel" name="phone" class="form-control" value="{{ auth()->user()->no_telepon }}" required>
                </div>
                <div class="form-group">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <form method="POST" action="{{ route('pengaturan.changePassword') }}">
                @csrf
                <div class="form-group">
