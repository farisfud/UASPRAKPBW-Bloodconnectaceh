...
<div class="auth-page">
  <div class="auth-container">
    <div style="text-align:center;margin-bottom:20px">
      <a href="<?php echo e(route('home')); ?>" style="display:inline-flex;align-items:center;gap:6px;font-size:0.8125rem;color:var(--text-secondary);transition:var(--transition-fast)" onmouseover="this.style.color='var(--primary)'" onmouseout="this.style.color='var(--text-secondary)'">
        ...
        <form id="registerForm" method="POST" action="<?php echo e(route('register')); ?>">
          ...
          <div class="form-row">
            ...
            <div class="form-group">
              ...
              <input type="tel" name="no_telepon" class="form-control" placeholder="08xxxxxxxxxx" value="<?php echo e(old('no_telepon')); ?>" required>
            </div>
          </div>
          <div class="form-group">
...
<?php /**PATH C:\Users\User\Desktop\informatika\UASLabPBOB_7-main\webportofolio\projectprakpbw-BloodConnect-Aceh-main (1)\backend-laravel\resources\views/login.blade.php ENDPATH**/ ?>